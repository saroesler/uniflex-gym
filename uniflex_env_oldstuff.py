...
'''
    ...
    def __init__(self, uniflex_controller, action_space_file, step_time):
        '''
        self.viewer = None
        ...
        '''
        # observation space is set by the reset function
        self.observation_space = spaces.Box(low=0, high=1000000000000, shape=1)
        ...
        self.action_space = spaces.Tuple((spaces.Discrete(3),
                                          ...
                                          spaces.Box(low=0, high=100, shape=1),
                                          spaces.Box(low=-180, high=180, shape=1)))
        self.uniflex_controller = uniflex_controller
        self.state = {}
...
'''
    ...
    def _get_state(self):
        self.uniflex_controller.get_bandwidth()
...
"""
    ...
    def _reset(self):
        ...
        self.observation_space, trash = spaces.Box(low=0, high=1000000000000, shape=len(self.state))
        return self.state
